...
async function getTokenWithPassword(authConfig) {
    ...
    try {
        ...
        const token = await makeRequest(`https://nuukacustomerwebapi.azurewebsites.net/api/v2.0/ClientToken?userName=${authConfig.email}&password=${authConfig.password}&grantType=password&format=json`);
